...
final class Banner {
    ...
    // http://patorjk.com/software/taag/#p=display&f=Slant&t=Krankenhaus%202024.10.1
    private static final String FIGLET = """
        ...
        """;
    private static final String SERVICE_HOST = System.getenv("Krankenhaus_SERVICE_HOST");
    private static final String KUBERNETES = SERVICE_HOST == null
        ? "N/A"
        : "Krankenhaus_SERVICE_HOST=" + SERVICE_HOST + ", Krankenhaus_SERVICE_PORT=" + System.getenv("Krankenhaus_SERVICE_PORT");
