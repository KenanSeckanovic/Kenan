 ...
 */
@RestController
@RequestMapping(KrankenhausGetController.API_PATH)
public class KrankenhausGetController {
    /// API ///
    public static final String API_PATH = "/krankenhaus";

    public static final String ID_PATTERN = "[\\da-f]{8}-[\\da-f]{4}-[\\da-f]{4}-[\\da-f]{4}-[\\da-f]{12}";

    private static final Logger LOGGER = LoggerFactory.getLogger(KrankenhausGetController.class);
     ...
     */
    public KrankenhausGetController(final KrankenhausReadService krankenhausReadService) {
